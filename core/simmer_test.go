...
func TestNew(t *testing.T) {
	...
	config := &Config{
		...
		DriverConfig: map[string]interface{}{
			database.ConfigSchema:    "schema",
			database.ConfigBlacklist: []string{"hangars"},
		},
	...
	cmd = exec.Command("go", "mod", "init", "github.com/randallmlough/simmer-test")
	...
	cmd = exec.Command("go", "mod", "edit", fmt.Sprintf("-replace=github.com/randallmlough/simmer=%s", filepath.Dir(string(goModFilePath))))
	cmd.Dir = state.Config.OutFolder
	cmd.Stderr = buf
