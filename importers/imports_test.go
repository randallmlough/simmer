...
func TestMergeSet(t *testing.T) {
	...
	a := Set{
		Standard:   List{"fmt"},
		ThirdParty: List{"github.com/randallmlough/simmer", "github.com/volatiletech/null/v8"},
	}
	b := Set{
		Standard:   List{"os"},
	...
	if c.ThirdParty[0] != "github.com/volatiletech/null/v8" && c.ThirdParty[1] != "github.com/randallmlough/simmer" {
		t.Errorf("Wanted: github.com/randallmlough/simmer, github.com/volatiletech/null/v8 got: %#v", c.ThirdParty)
	}
}
