...
type Collection struct {
	All  Set `toml:"all" json:"all,omitempty" yaml:"all"`
	Test Set `toml:"test" json:"test,omitempty" yaml:"test"`

	Singleton     Map `toml:"singleton" json:"singleton,omitempty" yaml:"singleton"`
	TestSingleton Map `toml:"test_singleton" json:"test_singleton,omitempty" yaml:"test_singleton"`

	BasedOnType Map `toml:"based_on_type" json:"based_on_type,omitempty" yaml:"based_on_type"`
}

// Set defines the optional standard imports and
// thirdParty imports (from github for example)
type Set struct {
	Standard   List `toml:"standard" yaml:"standard"`
	ThirdParty List `toml:"third_party" yaml:"third_party"`
}
