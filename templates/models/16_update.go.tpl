...
func (o *{{$alias.UpSingular}}) UpdateG({{if not .NoContext}}ctx context.Context, {{end -}} columns simmer.Columns) {{if .NoRowsAffected}}error{{else}}(int64, error){{end -}} {
	return o.Update({{if .NoContext}}simmer.GetDB(){{else}}ctx, simmer.GetContextDB(){{end}}, columns)
}
...
// See Update for more documentation.
func (o *{{$alias.UpSingular}}) UpdateP({{if .NoContext}}exec simmer.Executor{{else}}ctx context.Context, exec simmer.ContextExecutor{{end}}, columns simmer.Columns) {{if not .NoRowsAffected}}int64{{end -}} {
...
// See Update for more documentation.
func (o *{{$alias.UpSingular}}) UpdateGP({{if not .NoContext}}ctx context.Context, {{end -}} columns simmer.Columns) {{if not .NoRowsAffected}}int64{{end -}} {
	{{if not .NoRowsAffected}}rowsAff, {{end}}err := o.Update({{if .NoContext}}simmer.GetDB(){{else}}ctx, simmer.GetContextDB(){{end}}, columns)
	if err != nil {
		panic(simmer.WrapErr(err))
	}
	{{- if not .NoRowsAffected}}
...
func (o *{{$alias.UpSingular}}) Update({{if .NoContext}}exec simmer.Executor{{else}}ctx context.Context, exec simmer.ContextExecutor{{end}}, columns simmer.Columns) {{if .NoRowsAffected}}error{{else}}(int64, error){{end -}} {
...
func (q {{$alias.DownSingular}}Query) UpdateAllP({{if .NoContext}}exec simmer.Executor{{else}}ctx context.Context, exec simmer.ContextExecutor{{end}}, cols M) {{if not .NoRowsAffected}}int64{{end -}} {
...
func (q {{$alias.DownSingular}}Query) UpdateAllG({{if not .NoContext}}ctx context.Context, {{end -}} cols M) {{if .NoRowsAffected}}error{{else}}(int64, error){{end -}} {
	return q.UpdateAll({{if .NoContext}}simmer.GetDB(){{else}}ctx, simmer.GetContextDB(){{end}}, cols)
}
...
func (q {{$alias.DownSingular}}Query) UpdateAll({{if .NoContext}}exec simmer.Executor{{else}}ctx context.Context, exec simmer.ContextExecutor{{end}}, cols M) {{if .NoRowsAffected}}error{{else}}(int64, error){{end -}} {
...
func (o {{$alias.UpSingular}}Slice) UpdateAllG({{if not .NoContext}}ctx context.Context, {{end -}} cols M) {{if .NoRowsAffected}}error{{else}}(int64, error){{end -}} {
	return o.UpdateAll({{if .NoContext}}simmer.GetDB(){{else}}ctx, simmer.GetContextDB(){{end}}, cols)
}
...
func (o {{$alias.UpSingular}}Slice) UpdateAllGP({{if not .NoContext}}ctx context.Context, {{end -}} cols M) {{if not .NoRowsAffected}}int64{{end -}} {
	{{if not .NoRowsAffected}}rowsAff, {{end -}} err := o.UpdateAll({{if .NoContext}}simmer.GetDB(){{else}}ctx, simmer.GetContextDB(){{end}}, cols)
	if err != nil {
		panic(simmer.WrapErr(err))
	}
	{{- if not .NoRowsAffected}}
...
func (o {{$alias.UpSingular}}Slice) UpdateAllP({{if .NoContext}}exec simmer.Executor{{else}}ctx context.Context, exec simmer.ContextExecutor{{end}}, cols M) {{if not .NoRowsAffected}}int64{{end -}} {
...
func (o {{$alias.UpSingular}}Slice) UpdateAll({{if .NoContext}}exec simmer.Executor{{else}}ctx context.Context, exec simmer.ContextExecutor{{end}}, cols M) {{if .NoRowsAffected}}error{{else}}(int64, error){{end -}} {
	ln := int64(len(o))
	if ln == 0 {
