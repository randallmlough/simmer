...
func (o *{{$alias.UpSingular}}) ReloadG({{if not .NoContext}}ctx context.Context{{end}}) error {
	...
	return o.Reload({{if .NoContext}}simmer.GetDB(){{else}}ctx, simmer.GetContextDB(){{end}})
}
...
func (o *{{$alias.UpSingular}}) ReloadP({{if .NoContext}}exec simmer.Executor{{else}}ctx context.Context, exec simmer.ContextExecutor{{end}}) {
...
func (o *{{$alias.UpSingular}}) ReloadGP({{if not .NoContext}}ctx context.Context{{end}}) {
	if err := o.Reload({{if .NoContext}}simmer.GetDB(){{else}}ctx, simmer.GetContextDB(){{end}}); err != nil {
		panic(simmer.WrapErr(err))
	}
}
...
func (o *{{$alias.UpSingular}}) Reload({{if .NoContext}}exec simmer.Executor{{else}}ctx context.Context, exec simmer.ContextExecutor{{end}}) error {
...
func (o *{{$alias.UpSingular}}Slice) ReloadAllG({{if not .NoContext}}ctx context.Context{{end}}) error {
	...
	return o.ReloadAll({{if .NoContext}}simmer.GetDB(){{else}}ctx, simmer.GetContextDB(){{end}})
}
...
// and overwrites the original object slice with the newly updated slice.
// Panics on error.
func (o *{{$alias.UpSingular}}Slice) ReloadAllP({{if .NoContext}}exec simmer.Executor{{else}}ctx context.Context, exec simmer.ContextExecutor{{end}}) {
...
func (o *{{$alias.UpSingular}}Slice) ReloadAllGP({{if not .NoContext}}ctx context.Context{{end}}) {
	if err := o.ReloadAll({{if .NoContext}}simmer.GetDB(){{else}}ctx, simmer.GetContextDB(){{end}}); err != nil {
		panic(simmer.WrapErr(err))
	}
}
...
// and overwrites the original object slice with the newly updated slice.
func (o *{{$alias.UpSingular}}Slice) ReloadAll({{if .NoContext}}exec simmer.Executor{{else}}ctx context.Context, exec simmer.ContextExecutor{{end}}) error {
	if o == nil || len(*o) == 0 {
		return nil
	}
