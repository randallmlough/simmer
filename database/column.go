...
type Column struct {
	...
	Nullable  bool   `json:"nullable" toml:"nullable" yaml:"nullable"`
	Unique    bool   `json:"unique" toml:"unique" yaml:"unique"`
	Validated bool   `json:"validated" toml:"validated" yaml:"validated"`

	// Postgres only extension bits
	// ArrType is the underlying data type of the Postgres
	// ARRAY type. See here:
	// https://www.postgresql.org/docs/9.1/static/infoschema-element-types.html
	ArrType *string `json:"arr_type" toml:"arr_type" yaml:"arr_type"`
	UDTName string  `json:"udt_name" toml:"udt_name" yaml:"udt_name"`
	...
	DomainName *string `json:"domain_name" toml:"domain_name" yaml:"domain_name"`

	// MySQL only bits
	// Used to get full type, ex:
	// tinyint(1) instead of tinyint
	// Used for "tinyint-as-bool" flag
	FullDBType string `json:"full_db_type" toml:"full_db_type" yaml:"full_db_type"`
	...
	AutoGenerated bool `json:"auto_generated" toml:"auto_generated" yaml:"auto_generated"`
}
