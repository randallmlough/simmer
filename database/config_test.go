...
func TestConfigMustString(t *testing.T) {
	...
	for i, test := range tests {
		...
		func() {
			...
			value = ConfigMap(test.Config).MustString(key)
		}()
...
func TestConfigMustInt(t *testing.T) {
	...
	for i, test := range tests {
		...
		func() {
			...
			value = ConfigMap(test.Config).MustInt(key)
		}()
...
func TestConfigString(t *testing.T) {
	...
	for i, test := range tests {
		value, ok := ConfigMap(test.Config).String(key)
...
func TestConfigInt(t *testing.T) {
	...
	for i, test := range tests {
		value, ok := ConfigMap(test.Config).Int(key)
...
func TestConfigStringSlice(t *testing.T) {
	...
	for i, test := range tests {
		value, ok := ConfigMap(test.Config).StringSlice(key)
