...
var (
	...
	envHostname = database.DefaultEnv("DRIVER_HOSTNAME", "localhost")
	envPort     = database.DefaultEnv("DRIVER_PORT", "5432")
	envUsername = database.DefaultEnv("DRIVER_USER", "sqlboiler_driver_user")
	envPassword = database.DefaultEnv("DRIVER_PASS", "sqlboiler")
	envDatabase = database.DefaultEnv("DRIVER_DB", "sqlboiler_driver_test")
)
