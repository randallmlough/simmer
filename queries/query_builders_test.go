...
func TestBuildQuery(t *testing.T) {
	...
	for i, test := range tests {
		...
		test.q.dialect = &database.Dialect{LQ: '"', RQ: '"', UseIndexPlaceholders: true}
...
func TestWriteStars(t *testing.T) {
	...
	for i, test := range tests {
		test.In.dialect = &database.Dialect{LQ: '"', RQ: '"', UseIndexPlaceholders: true}
...
func TestWriteAsStatements(t *testing.T) {
	...
	query := Query{
		...
		dialect: &database.Dialect{LQ: '"', RQ: '"', UseIndexPlaceholders: true},
	}
