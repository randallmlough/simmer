...
func (testEagerL) LoadChildOne(_ simmer.Executor, singular bool, obj interface{}, mods Applicator) error {
...
func (testEagerL) LoadChildMany(_ simmer.Executor, singular bool, obj interface{}, mods Applicator) error {
	var toSetOn []*testEager
	if singular {
		toSetOn = []*testEager{obj.(*testEager)}
	} else {
...
func (testEagerChildL) LoadNestedOne(_ simmer.Executor, singular bool, obj interface{}, mods Applicator) error {
...
func (testEagerChildL) LoadNestedMany(_ simmer.Executor, singular bool, obj interface{}, mods Applicator) error {
	var toSetOn []*testEagerChild
	if singular {
		toSetOn = []*testEagerChild{obj.(*testEagerChild)}
	} else {
...
func (testEagerL) LoadZeroOne(_ simmer.Executor, singular bool, obj interface{}, mods Applicator) error {
	var toSetOn []*testEager
	if singular {
		toSetOn = []*testEager{obj.(*testEager)}
	} else {
...
func (testEagerL) LoadZeroMany(_ simmer.Executor, singular bool, obj interface{}, mods Applicator) error {
	var toSetOn []*testEager
	if singular {
		toSetOn = []*testEager{obj.(*testEager)}
	} else {
...
func (testEagerZeroL) LoadNestedOne(_ simmer.Executor, singular bool, obj interface{}, mods Applicator) error {
	return nil
}

func (testEagerZeroL) LoadNestedMany(_ simmer.Executor, singular bool, obj interface{}, mods Applicator) error {
	return nil
}
